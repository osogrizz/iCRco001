...
const NurseHero3 = () => {
  const { image, logo } = useStaticQuery(graphql`
    query {
      ...
      logo: file(relativePath: { eq: "AirDRLE_logo_MAIN.png" }) {
        sharp: childImageSharp {
  ...
  return (
    ...
    >
      <Container>
        ...
        <hr />
        <p>
          The <strong>AirDR LE™</strong> System has been specifically designed
          ...
          Detection (AED), the AirDR LE™ System is compatible with any X-ray
